...
export default function Project({ project }) {
  return (
    <div className="min-h-96 h-auto w-full p-2 flex flex-col items-start z-10 rounded-xl shadow-sm hover:shadow-md hover:shadow-primary shadow-primary relative">
      <div className="">
        <img
          src={`${project.image}`}
          alt={`'${project.title}' \n Error Loading`}
