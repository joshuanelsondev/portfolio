...
export default function ContactComponent () {
  ...
  const sendEmail = (e) => {
    ...
    return (
      <div id='contact' className="h-full min-h-[600px] w-screen max-w-[800px] flex flex-col bg-[#f2f2f2] rounded-md  mb-40 p-4 shadow-md shadow-gray scale-[90%] sm:scale-[80%] lg:scale-100 mt-20">
