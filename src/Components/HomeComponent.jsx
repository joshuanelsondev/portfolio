...
export default function HomeComponent({ setShowNav }) {
    ...
    return (
      <div className="flex flex-col md:flex-row-reverse md:justify-center shrink-0 justify-center lg:justify-start lg:pt-32 items-center gap-10 h-screen sm:w-screen lg:w-auto z-10">
        <img
          src={PursuitHeadshot}
