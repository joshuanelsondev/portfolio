...
export default function HomeComponent() {
    ...
    return (
      <div id='home' className="h-full min-h-[600px] w-full min-w-fit z-10 pt-10 md:mb-24">
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col w-auto h-auto z-10 text-center">
            ...
            <h2 className="text-2xl sm:text-3xl 2xl:text-4xl mt-2 font-normal text-darkGray dark:text-primary">
              <span className="text-primary dark:text-white">Software</span> Developer
            </h2>
            {/* Icons iteration */}
            <div className="flex mt-4 gap-4 sm:gap-8 justify-center">
              {icons.map((icon) => {
                return (
                  <div
                    key={icon.id}
                  ...
                  >
                    ...
                    >
                      <icon.logo
                        className="p-2 text-primary h-9 sm:h-10 dark:text-white cursor-pointer hover:border-b border-b-primary"
                        size={40}
                      />
                    </a>
                  </div>
